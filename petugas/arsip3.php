        ...
        <div class="panel-body">
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    $no = 1;
                    $saya = $_SESSION['id'];
                    $arsip = mysqli_query($koneksi,"SELECT * FROM arsipp,petugas WHERE arsip_petugass=petugas_id and arsip_petugass='$saya' ORDER BY arsip_idd DESC");
                    while($p = mysqli_fetch_array($arsip)){
                        ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><?php echo date('H:i:s  d-m-Y',strtotime($p['arsip_waktu_uploadd'])) ?></td>
                            <td>

                                <b>KODE</b> : <?php echo $p['arsip_kodee'] ?><br>
                                <b>Nama</b> : <?php echo $p['arsip_namaa'] ?><br>
                                <b>Jenis</b> : <?php echo $p['arsip_jeniss'] ?><br>
