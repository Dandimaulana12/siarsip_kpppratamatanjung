                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Data NPWP</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="container-fluid">
    <div class="panel panel">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Data NPWP saya</h3>
        </div>
        <div class="panel-body">


            <div class="pull-right">
                <a href="npwp_tambah.php" class="btn btn-primary"><i class="fa fa-cloud"></i> Tambah NPWP</a>
            </div>
                    ...
                    while($p = mysqli_fetch_array($arsip)){
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="npwp_hapus.php?id=<?php echo $p['npwp_id']; ?>" class="btn btn-primary"><i class="fa fa-check"></i> &nbsp; Ya, hapus</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="btn-group">
                                    <a href="npwp_edit.php?id=<?php echo $p['npwp_id']; ?>" class="btn btn-default"><i class="fa fa-wrench"></i></a>
