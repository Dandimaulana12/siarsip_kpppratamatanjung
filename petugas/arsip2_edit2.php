        ...
        <div class="panel-body">
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    $data2 = mysqli_query($koneksi, "SELECT * from arsip_npwp,petugas where id_npwp='$arsip2' and arsipp_petugas=petugas_id and arsipp_petugas='$saya'");
                    while($d = mysqli_fetch_array($data2)){
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    <a href="arsip2_edit3.php?id=<?php echo $d['arsipp_id'];?>" class="btn btn-default"><i class="fa fa-wrench"></i></a>
